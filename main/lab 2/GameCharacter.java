...
public class GameCharacter implements Serializable {
   ...
   // Position position;
    ...
    private GameCharacter(String name, int health, int armor, int damage, int shootingRange, int x, int y) {
        this.name = name;
        this.health = health;
        this.armor = armor;
        this.damage = damage;
   ...
   public int getX() {
    ...
    public class Builder {
        ...
        public GameCharacter build() throws IllegalArgumentException {
            ...
            if(GameCharacter.this.x == null) emptyFields.add("x");

            if(GameCharacter.this.y == null) emptyFields.add("y");
        ...
        public GameCharacter build(GameCharacter player) {
            ...
            GameCharacter.this.x = player.x;
            GameCharacter.this.y = player.y;
